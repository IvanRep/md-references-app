  ...
  checkReferences(referenceList: Reference[]) {
    if (referenceList.length === 0) {
      ...
      this.messagesDisplayService.subject.next({
        ...
        icon: `<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-checks" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#00b341" fill="none" stroke-linecap="round" stroke-linejoin="round">
